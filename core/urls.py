...
from .views import HomeView,ItemDetailView,CheckoutView,add_to_cart,remove_from_cart,OrderSummaryView,remove_single_item_from_cart,PaymentMethod,AddCouponView,CategoryListView,RequestRefundView,ProfileView,product
